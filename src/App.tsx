...
import DemoInvestorFlow from './components/DemoInvestorFlow';
import { 
  Map as MapIcon, Wallet, Calendar, User, ShieldCheck, 
  X, Printer, CheckCircle2, ChevronRight, FileText, 
  Settings, Check, ArrowLeft, HeartPulse, LogOut, Lock, LogIn, Trash2, HelpCircle, Activity
} from 'lucide-react';
...
export default function App() {
  ...
  const openInvestorDemo = () => setView('demo-investor');
          ...
          <div className="flex items-center gap-3">
            ...
            {patientUser && (
              <>
                ...
                <button
                  onClick={openInvestorDemo}
                  className={`hidden lg:inline-flex items-center gap-2 px-3 py-2 rounded-2xl border text-xs font-bold font-sans transition-all cursor-pointer ${
                    view === 'demo-investor'
